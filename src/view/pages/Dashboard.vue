...
import AdvancedTable from "@/view/components/dashboard/AdvancedTable.vue";
import StatisticCount from "@/view/components/dashboard/StatisticCount.vue";
import ListWidget1 from "@/view/components/dashboard/Widget1.vue";
